Algoritmo sin_titulo
	...
	Escribir '¿Desea agregar al Porta Aviones? Escriba 0 para no'
	Leer opt
	Si opt<>'0' Entonces
	...
	FinSi
	salir <- Falso
	Escribir '¿Desea agregar al Acorazado? Escriba 0 para no'
	Leer opt
	Si opt<>'0' Entonces
		Mientras salir=Falso Hacer
			cancelar <- Falso
	...
	FinSi
	salir <- Falso
	Escribir '¿Desea agregar la Lancha? Escriba 0 para no'
	Leer opt
	Si opt<>'0' Entonces
		Mientras salir=Falso Hacer
			cancelar <- Falso
